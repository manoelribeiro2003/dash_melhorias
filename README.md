...
- Criar um modal
- Adicionar no modal um container branco (talvez um card)
- Criar um formulario que com um botão sai do modo edição e vai para o modo leitura e vice versa
- Adicionar um formulario com os controles para editar a parte Dados do Projeto
